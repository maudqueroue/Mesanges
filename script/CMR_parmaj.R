...
# hvie_to_keep <- which((hvie_parmaj$vector_ID_PROG_parmaj %in% ID)==TRUE)
# hvie_parmaj <- hvie_parmaj[hvie_to_keep,]
# N <- dim(hvie_parmaj)[1]
# 
# for(i in 1:N){
#   hvie_parmaj$vector_ID_PROG_parmaj[i] <- which(hvie_ID_PROG_parmaj$ID_PROG==hvie_parmaj$ID_PROG[i])
# }
# 
